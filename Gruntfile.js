			...
			target: {
				options: {
					...
					processPot: function( pot, options ) {
						...
						pot.headers['last-translator'] = 'Wilber Tobar <ale_tobar@hotmail.es>\n';
						pot.headers['language-team'] = 'Wilber Tobar <ale_tobar@hotmail.es>\n';
						pot.headers['x-poedit-basepath'] = '.\n';
						pot.headers['x-poedit-language'] = 'Spanish\n';
						pot.headers['x-poedit-country'] = 'EL SALVADOR\n';
